...
\position{Software Engineering Student}%{\enskip\cdotp\enskip}Web Developer} % 
%%Your 
%expertise/fields
...
\recipient{McMaster University}{1280 Main St W\\Hamilton, ON\\L8S 4L8} % The 
%company %being applied to

\letterdate{\today} % The date on the letter, default is the date of compilation

\lettertitle{Job Application for Instructional Assistant Intern - Engineer 1D04 
(Job ID: 73988)}	%The title of the letter
